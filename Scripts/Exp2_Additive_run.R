...
source("C:/Users/alessandro.colombi/ScriptSpecies_shared/SimStudyRaf/SimStudyRaf_functions.R")
...
nome_base1 = paste0("save/Pr1step_Additive_")
...
for(idx in 1:Nrun ){
  ...
  ## Run
  Pr1step_ngrid = Pr1step_Nrep_fit(prob_true_mat1, prob_true_mat2, ngrid, 
                                   n1_prop = n1_prop,
